...
class AppColors {
  ...
  static const Color textPrimaryColor  = Color(0xFFFDF6C5);
  static const Color text6BD45  = Color(0xFFE6BD45);
  static const Color text121212  = Color(0xFF121212);
  static const Color textA7282  = Color(0xFF6A7282);
  ...
  static const green = Color(0xFF31993B);
